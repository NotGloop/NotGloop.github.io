    ...
    *}
    <ul class="nav nav-pills">
        <li class="nav-item dropup">
            <a style="color:white;" class="nav-link dropdown-toggle nl-copyright" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">&copy; NamelessMC {'Y'|date}</a>
