    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="alert alert-danger">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{$NEW_ENTRY_LINK}" class="btn btn-primary">{$NEW_ENTRY}</a>
                        <hr /> {if isset($SUCCESS)}
                        ...
                        {/if} {if count($ENTRY_LIST)}
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <tbody>
                                    <tr>
                                        <td><strong>{$RULES_ENTRY_NUMBER}</strong></td>
                                        <td><strong><div class="float-md-right">{$RULES_ACTION}</div></strong></td>
                                    </tr>
                                    {foreach from=$ENTRY_LIST item=entry}
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="float-md-right">
                                                <a class="btn btn-warning btn-sm" href="{$entry.edit_link}"><i class="fas fa-edit fa-fw"></i></a>
                                                <button class="btn btn-danger btn-sm" type="button" onclick="showDeleteModal('{$entry.delete_link}')"><i class="fas fa-trash fa-fw"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                    {/foreach}
                        ...
                        {else} {$NO_RULES_ENTRIES} {/if}
                        <hr>
                        <form action="" method="post">
                            <div class="form-group">
                                <label for="InputTitle">{$TITLE_TYPE}</label><br />
				<select class="form-control" id="InputTitle" name="title">
                                    <option value="title"{if $TITLE_VALUE eq title} selected{/if}>{$TITLE_TYPE_TITLE}</option>
                                    <option value="number"{if $TITLE_VALUE eq number} selected{/if}>{$TITLE_TYPE_NUMBER}</option>
                                </select>
                            </div>
                            <div class="form-group">
